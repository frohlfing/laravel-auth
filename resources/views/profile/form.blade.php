                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('profile.update')}}" accept-charset="UTF-8" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" name="name" value="{{old('name') ?: $user->name}}" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{__('users.model.name')}}" maxlength="255" required="required" autofocus="autofocus"/>
                                    @if ($errors->has('name'))
                            ...
                            {{--<div class="form-group row">--}}
                                ...
                                {{--</label>--}}
                                {{--<div class="col-md-6">--}}
                                    {{--<input id="api_token" value="{{old('api_token') ?: $user->api_token}}" type="text" class="form-control{{ $errors->has('api_token') ? ' is-invalid' : '' }}" placeholder="{{__('users.model.api_token')}}" readonly="readonly"/>--}}
